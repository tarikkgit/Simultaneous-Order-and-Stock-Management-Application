...
public class CustomerPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        custTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "Customer Code", "Full Name", "Location", "Contact", "Username", "Password"
                }
        ));
   ...
   private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
    if (codeText.getText().equals("") || nameText.getText().equals("")
        ...
        customerDTO.setPassword(new String(passwordText.getPassword()));
  ...
  private void custTableMouseClicked(java.awt.event.MouseEvent evt) {
    ...
    // Sadece tablo yeterli sütun sayısına sahipse
    if (col > 4) {
        usernameText.setText((String) data[4]);
        passwordText.setText((String) data[5]);
    } else {
        usernameText.setText("");
        passwordText.setText("");
    }
